...
(declare-fun $V26_i$0 () Int)
(declare-fun $OK$0 () Bool)
(declare-fun $V31_env$0 () Bool)
(declare-fun $V74_X$0 () Bool)
(declare-fun $V79_Sofar$0 () Bool)
(declare-fun $V87_First$0 () Int)
(assert (T true $etat1$~1 $etat2$~1 $etat3$~1 $a_init$~1 $V26_i$~1 $OK$~1 $V31_env$~1 $V74_X$~1 $V79_Sofar$~1 $V87_First$~1 $etat1$0 $etat2$0 $etat3$0 $a_init$0 $V26_i$0 $OK$0 $V31_env$0 $V74_X$0 $V79_Sofar$0 $V87_First$0))
