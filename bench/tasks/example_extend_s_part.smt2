...
(declare-fun $prop_all$1 () Bool)
(declare-fun $bias_max$1 () Bool)
(assert (T %init $x$~1 $state$~1 $bias$~1 $prop1$~1 $prop2$~1 $prop3$~1 $prop4$~1 $prop_all$~1 $bias_max$~1 $x$0 $state$0 $bias$0 $prop1$0 $prop2$0 $prop3$0 $prop4$0 $prop_all$0 $bias_max$0))
(assert $prop_all$0)
