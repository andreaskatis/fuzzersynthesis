...
(assert (and (T true $x$~1 $state$~1 $bias$~1 $prop1$~1 $prop2$~1 $prop3$~1 $prop4$~1 $prop_all$~1 $bias_max$~1 $x$0 $state$2 $bias$2 $prop1$2 $prop2$2 $prop3$2 $prop4$2 $prop_all$2 $bias_max$2) $prop_all$2))
