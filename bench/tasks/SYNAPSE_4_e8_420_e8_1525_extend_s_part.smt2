...
(assert (T %init $e_s1$~1 $e_s2$~1 $e_s3$~1 $init_invalid_s$~1 $V28_valid_s$~1 $V29_dirty_s$~1 $OK$~1 $V31_env$~1 $V84_X$~1 $e_s1$0 $e_s2$0 $e_s3$0 $init_invalid_s$0 $V28_valid_s$0 $V29_dirty_s$0 $OK$0 $V31_env$0 $V84_X$0))
