...
(assert (and (T %init $diff$~1 $V22_speed$~1 $V23_plus$~1 $V24_minus$~1 $OK$~1 $V25_realistic$~1 $V93_X$~1 $V98_Sofar$~1 $V109_cpt$~1 $V110_acceptable$~1 $diff$0 $V22_speed$2 $V23_plus$2 $V24_minus$2 $OK$2 $V25_realistic$2 $V93_X$2 $V98_Sofar$2 $V109_cpt$2 $V110_acceptable$2) $OK$2))
