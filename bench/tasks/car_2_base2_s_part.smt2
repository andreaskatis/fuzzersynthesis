...
(assert (T true $m$~1 $s$~1 $V27_dist$~1 $OK$~1 $V33_env$~1 $V91_X$~1 $m$0 $s$0 $V27_dist$0 $OK$0 $V33_env$0 $V91_X$0))
(assert $OK$0)
(assert (T false $m$0 $s$0 $V27_dist$0 $OK$0 $V33_env$0 $V91_X$0 $m$1 $s$1 $V27_dist$1 $OK$1 $V33_env$1 $V91_X$1))
