...
(declare-fun $V109_cpt$1 () Int)
(declare-fun $V110_acceptable$1 () Bool)
(assert (T true $diff$~1 $V22_speed$~1 $V23_plus$~1 $V24_minus$~1 $OK$~1 $V25_realistic$~1 $V93_X$~1 $V98_Sofar$~1 $V109_cpt$~1 $V110_acceptable$~1 $diff$0 $V22_speed$0 $V23_plus$0 $V24_minus$0 $OK$0 $V25_realistic$0 $V93_X$0 $V98_Sofar$0 $V109_cpt$0 $V110_acceptable$0))
(assert $OK$0)
(assert (T false $diff$0 $V22_speed$0 $V23_plus$0 $V24_minus$0 $OK$0 $V25_realistic$0 $V93_X$0 $V98_Sofar$0 $V109_cpt$0 $V110_acceptable$0 $diff$1 $V22_speed$1 $V23_plus$1 $V24_minus$1 $OK$1 $V25_realistic$1 $V93_X$1 $V98_Sofar$1 $V109_cpt$1 $V110_acceptable$1))
