...
(assert (and (T %init $igsw$~1 $ccd$~1 $cconoff$~1 $bpa$~1 $cccanc$~1 $battok$~1 $gearok$~1 $qfok$~1 $sdok$~1 $accok$~1 $ccseti$~1 $ccsetd$~1 $ccr$~1 $vs$~1 $V86_ccont$~1 $~flatten0$~1 $V87_cca$~1 $OK$~1 $V82_p1$~1 $V83_p2$~1 $V84_p3$~1 $V85_p4$~1 $igsw$0 $ccd$0 $cconoff$0 $bpa$0 $cccanc$0 $battok$0 $gearok$0 $qfok$0 $sdok$0 $accok$0 $ccseti$0 $ccsetd$0 $ccr$0 $vs$0 $V86_ccont$2 $~flatten0$2 $V87_cca$2 $OK$2 $V82_p1$2 $V83_p2$2 $V84_p3$2 $V85_p4$2) $OK$2))
