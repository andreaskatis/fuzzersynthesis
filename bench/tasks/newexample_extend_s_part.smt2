...
(declare-fun $guarantee_all$1 () Bool)
(declare-fun $bias_max$1 () Bool)
(assert (T %init $x$~1 $state$~1 $bias$~1 $guarantee1$~1 $guarantee2$~1 $guarantee3$~1 $guarantee4$~1 $guarantee5$~1 $guarantee_all$~1 $bias_max$~1 $x$0 $state$0 $bias$0 $guarantee1$0 $guarantee2$0 $guarantee3$0 $guarantee4$0 $guarantee5$0 $guarantee_all$0 $bias_max$0))
