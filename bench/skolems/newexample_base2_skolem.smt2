...
(assert (let ((a!1 (and (= $x$1 1)
      ...
      (a!8 (or $bias_max$0
               (>= (+ (- 1) $bias$0) 2)
               (<= (+ (- 1) $bias$0) (- 0 2))))
      (a!9 (or (= (+ (- 1) $bias$0) 0) (not (= 1 0))))
      (a!10 (or (not (and (= $state$0 0) (= $x$1 1))) (= 1 2))))
(let ((a!5 (= $guarantee_all$3 (and true (or (not a!2) (= 2 3)) a!4 true a!3)))
      (a!11 (= $guarantee_all$3 (and true (or (not a!8) (= 1 3)) true a!9 a!10))))
(let ((a!6 (and (= $bias$3 (+ 1 $bias$0))
                ...
                (= $guarantee5$3 true)
                a!5))
      (a!12 (and (= $bias$3 (+ (- 1) $bias$0))
                 (= $bias_max$3 a!8)
                 (= $guarantee1$3 a!9)
                 (= $state$3 1)
                 (= $guarantee2$3 a!10)
                 (= $guarantee3$3 true)
                 (= $guarantee4$3 (or (not a!8) (= 1 3)))
                 (= $guarantee5$3 true)
                 a!11)))
  (ite a!1 a!6 (ite a!7 a!12 true))))))
(check-sat)
