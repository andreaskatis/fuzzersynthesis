...
(assert (let ((a!1 (or (not (or (not $in_station$1) (not $V274_X$0))) $V62_door_ok$0))
      (a!3 (not (or (and $request_door$0 (not $warning_start$0))
...
(let ((a!2 (and (not (or (not $door_is_open$1) (not $V273_X$0)))
      ...
      (a!9 (and true
                ...
                a!8))
      (a!11 (or a!10 (ite false false (or (not $in_station$1) (not $V252_X$0))))))
(let ((a!4 (or (not a!2) (and (or (not $door_is_open$1) $in_station$1) a!3)))
